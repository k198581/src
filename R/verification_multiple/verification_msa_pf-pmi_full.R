...
# matchingrate path
ansrate.file <- paste("../../Alignment/", ansrate, "_pf-pmi_gap-op-new_", format(Sys.Date()), ".txt", sep = "")

# result path
output.dir <- paste("../../Alignment/", multiple, "_pf-pmi_gap-op-new_", format(Sys.Date()), "/", sep = "")
